import { ArrowRight, Backpack, CakeSlice, KeyRound, Ribbon, Wrench, type LucideIcon } from "lucide-react";
...
export function ToolCard({ tool }: { tool: LabTool }) {
  const look = LOOK[tool.id] ?? { icon: Wrench, tone: "neutral" as const };
